...
python3 parallelized_inject_onnx_transformer.py --directory_name input/encoder --module Encoder --experiment_output_name results_fault_injection/results.csv 
